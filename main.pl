...
% ---------- Appel IA (gère les signatures différentes)
call_ai(ia_v1, Board, Player, Col) :-
    ia_v1(Board, Player, Col).

call_ai(ia_v2, Board, Player, Col) :-
    ia_v2(Board, Player, Col).

call_ai(ia_alphabeta, Board, Player, Col) :-
    ia_alphabeta(Board, Player, Col).

% minimax est codé "vu de o" => adaptation si Player = x
call_ai(ia_minimax, Board, 'o', Col) :-
